...
class ExamplePage extends React.Component<void, State> {
  ...
  onLayoutChange = (layout) => {
    // this.setState({ layout[currentLayout]: layout })
  ...
  stringifyLayout() {
    return this.state.layout['sm'].map(function (l) {
      return (
  ...
  render() {
    ...
    if (form.length > 0) {
      ...
      schemaForm = (
        <LayoutBuilder
          handleLayoutChange={this.onLayoutChange}
          handleFieldSelect={this.onFieldSelect}
